...
public interface IExtendedBlockProperties {
    ...
    /**
     * Set to false if the Block-texture has an alpha channel See here for more information:
    ...
    /**
     * Set to 0 if the Block-texture has no alpha channel IE : Dirt. Set to 1 if the Block-texture has an alpha channel
     * IE : Ice
     *
